	...
	def get_balanced_bits(self, r):
		...
		for i in range(0,64):
			...
			for j in range(0,64):	
				...
				File_model_w_init.close()
				stp_parameters = ["stp", "Presentinit.cvc", "--cryptominisat", "--threads", "4"]
...
if __name__ == '__main__':
	sbox = [0x6, 0xB, 0x5, 0x4, 0x2, 0xE, 0x7, 0xA, 0x9, 0xD, 0xF, 0xC, 0x3, 0x1, 0x0, 0x8]     # small-aes cipher
	...
	"""
	# B = A.get_balanced_bits(5)

	C = get_row(0)
	res = A.check_with_const_col(5,C)
	print(res)	
